import { PrismaClient, Role, ProductUnit, DiscountType } from '@prisma/client';
...
async function main() {
  ...
  // 3. Seed Default Customer Address
  ...
  for (const prod of products) {
    ...
    // Record initial inventory receipt in log
