...
class CreateProductDto {
    constructor() {
        this.unit = client_1.ProductUnit.PIECE;
        this.unitStep = 1.0;
...
__decorate([
    (0, class_validator_1.IsUUID)('4', { message: 'Valid category UUID is required' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsPositive)({ message: 'Price must be greater than 0' }),
    __metadata("design:type", Number)
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(client_1.ProductUnit, { message: 'Invalid product unit' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsPositive)(),
    __metadata("design:type", Number)
], CreateProductDto.prototype, "unitStep", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsInt)(),
